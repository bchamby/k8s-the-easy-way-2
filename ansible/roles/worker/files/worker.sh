...
sudo mkdir -p /etc/containers /etc/cni/net.d /etc/crio /opt/cni/bin /usr/local/libexec/crio /var/lib/kubelet /var/lib/kube-proxy /var/lib/kubernetes /var/run/kubernetes
